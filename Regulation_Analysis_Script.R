...
setwd("~/Regulations-2018/Finalisation/Data/")
...
regulations_data$PRESCRIPTIVITY_score <- regulations_data$PRESCRIPTIVITY_prescriptions_Index / regulations_data$PRESCRIPTIVITY_permissions_Index
...
regulations_data$COMPLEXITY_internal__referencing_Index <- regulations_data$COMPLEXITY_cross_referencing_RawCount/(regulations_data$wordcount/100)
